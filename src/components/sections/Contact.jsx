...
import { MdEmail, MdSend, MdPerson, MdMessage, MdCheckCircle, MdError } from "react-icons/md";
    ...
    >
      <RevealOnScroll>
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className={`group relative overflow-hidden p-8 rounded-2xl border hover:-translate-y-2 transition-all duration-500 hover:shadow-2xl hover-lift ${
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  className={`w-full bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white py-4 px-6 rounded-xl transition-all duration-300 font-medium hover:shadow-xl hover:scale-105 group/btn relative overflow-hidden ${
                    isSubmitting ? 'opacity-75 cursor-not-allowed scale-100' : ''
                  }`}
                >
                  <div className="flex items-center justify-center gap-3 relative z-10">
                    {isSubmitting ? (
                      ...
                      <>
                        <MdSend className="text-lg group-hover/btn:animate-bounce" />
