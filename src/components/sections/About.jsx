...
export const About = ({ isDarkMode }) => {
  ...
  const backendSkills = ["Node.js", "MySQL", "PostgreSQL", "MongoDB", "Prisma"];
  const devopsSkills = ["Git & Github", "Docker", "Linux", "AWS"];
    ...
    >
      <RevealOnScroll>
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className={`group relative overflow-hidden p-8 rounded-2xl border hover:-translate-y-2 transition-all duration-500 hover:shadow-2xl hover-lift mb-12 ${
            ...
            <div className="absolute bottom-6 left-6 w-2 h-2 bg-cyan-500 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
            ...
            <div className="relative z-10">
              <p className={`text-center leading-relaxed text-lg ${
                ...
                and creating innovative solutions that make a difference. I love turning complex problems 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className={`group relative overflow-hidden p-8 rounded-2xl border hover:-translate-y-3 hover:shadow-2xl transition-all duration-500 hover-lift ${
              ...
              {/* Decorative elements */}
              <div className="absolute top-6 right-6 w-3 h-3 bg-blue-500 rounded-full animate-pulse"></div>
              <div className="absolute bottom-6 left-6 w-2 h-2 bg-cyan-500 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
            ...
            <div className={`group relative overflow-hidden p-8 rounded-2xl border hover:-translate-y-3 hover:shadow-2xl transition-all duration-500 hover-lift ${
              ...
              <div className="absolute bottom-6 left-6 w-2 h-2 bg-emerald-500 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className={`text-xl font-bold group-hover:text-green-400 transition-colors duration-300 ${
                    isDarkMode ? "text-white" : "text-gray-900"
                  }`}>Backend</h3>
                </div>
            ...
            <div className={`group relative overflow-hidden p-8 rounded-2xl border hover:-translate-y-3 hover:shadow-2xl transition-all duration-500 hover-lift ${
              ...
              <div className="absolute bottom-6 left-6 w-2 h-2 bg-pink-500 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
          ...
          {/* Education Section */}
          <div className={`group relative overflow-hidden p-6 rounded-2xl border hover:-translate-y-2 transition-all duration-500 hover:shadow-2xl hover-lift ${
            isDarkMode ? "border-white/10 hover:border-red-400/50 bg-gray-900" : "border-gray-200 hover:border-red-300 bg-white"
          }`}>
            {/* Animated background gradient overlay */}
            <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${
              isDarkMode ? "bg-gradient-to-br from-red-500/10 to-rose-500/10" : "bg-gradient-to-br from-red-100/50 to-rose-100/50"
            }`}></div>
            
            {/* Decorative elements */}
            <div className="absolute top-4 right-4 w-2 h-2 bg-red-400 rounded-full animate-pulse"></div>
            <div className="absolute bottom-4 left-4 w-1.5 h-1.5 bg-rose-400 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                <div className={`p-4 rounded-lg border transition-all duration-300 hover:-translate-y-1 ${
                  isDarkMode ? "border-white/5 bg-gray-800/30" : "border-gray-100 bg-gray-50/50"
                }`}>
                ...
                <div className={`p-4 rounded-lg border transition-all duration-300 hover:-translate-y-1 ${
                  ...
                  <p className={`mb-2 text-sm ${
                    ...
                    Paramount International School (2021-2022)
                  </p>
                  <span className="bg-red-500/10 text-red-500 py-1 px-2 rounded-full text-xs font-medium">
                    Percentage: 76%
                  </span>
                ...
                <div className={`p-4 rounded-lg border transition-all duration-300 hover:-translate-y-1 ${
                  ...
                  <p className={`mb-2 text-sm ${
                    ...
                    Paramount International School (2019-2020)
                  </p>
                  <span className="bg-red-500/10 text-red-500 py-1 px-2 rounded-full text-xs font-medium">
                    Percentage: 91%
                  </span>
